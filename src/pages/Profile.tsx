...
const adminCopy = {
  ...
  zh: {
    title: '管理员控制台',
    subtitle: 'root 数据仅用于测试，不会进入排行榜。重置会把玩家恢复成干净账号状态，并撤销当前会话。',
        ...
        <div className="flex min-w-0 items-center gap-4">
          <div className="relative shrink-0">
            <img
              ...
              className="h-20 w-20 aspect-square overflow-hidden rounded-full border-4 border-zinc-900 object-cover object-center shadow-xl"
