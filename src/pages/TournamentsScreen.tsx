...
const copy = {
  ...
  zh: {
    ...
    createTournamentBlocked: '当前已经有一场管理员职业赛在进行中。',
    startTournament: '生成对阵表',
    cancelTournament: '取消赛事',
    forceSettle: '强制结算',
    adminScoreAction: '管理员录分',
    adminScoreTitle: '管理员录入赛果',
    adminScoreHint: '选中对阵表中的一场比赛后，可在这里直接录入最终比分并结算。',
    adminScoreSubmitLabel: '保存赛果',
    noRegistration: '当前没有正在报名的职业赛。',
    noOngoing: '当前没有正在进行的职业赛。',
    previewTitle: '下周职业赛',
    previewDescription: '提前查看下一场系统职业赛。',
    previewBadge: '预览',
    systemSource: '系统发布',
    adminSource: '管理员发布',
    viewBracket: '打开对阵表',
    bracketTitle: '实时对阵表',
    closeBracket: '关闭',
    bracketHint: '对阵表会以横向长图形式展示，在窗口内拖动即可查看完整签表。',
    rootOnly: '发布、生成对阵、取消和紧急结算由 root 管理员控制。',
    participants: '球员',
    registeredListTitle: '已报名球员',
    matchComments: '职业赛比赛评论',
    commentPlaceholder: '比赛结束后说两句...',
    postComment: '发布评论',
    noComments: '还没有评论。',
    commentsLocked: '比赛完成后才可评论。',
    noBracket: '报名完成后生成对阵表。',
    tournamentCancelled: '这场职业赛已被取消。',
    minPlayersHint: '至少 4 人、最多 8 人后才能正式开赛。',
    registrationClosed: '生成对阵后将停止报名。',
    createSuccess: '职业赛已创建。',
    startSuccess: '对阵表已生成。',
    cancelSuccess: '职业赛已取消。',
    settleSuccess: '职业赛已结算。',
    adminScoreSuccess: '对阵结果已保存。',
    commentSuccess: '评论已发布。',
    cancelConfirm: '确认取消这场职业赛吗？该操作不可撤销。',
    startConfirm: '确认生成对阵表并关闭报名吗？',
    settleConfirm: '确认立即强制结算这场职业赛吗？',
    noProfileForBracket: '部分参赛球员资料未加载完成，请刷新后重试。',
    noPreviewCta: '系统职业赛会按周自动刷新。',
    cardSummaryRegistration: '正式单败淘汰赛，包含季军赛。',
    cardSummaryOngoing: '对阵已生成，可打开对阵表查看晋级情况。',
  },
} as const;
